...
void function OnWeaponStartZoomOut_weapon_esaw( entity weapon )
{
	HopupGunshield_OnWeaponStartZoomOut( weapon )
}

void function OnWeaponOwnerChanged_weapon_esaw( entity weapon, WeaponOwnerChangedParams changeParams )
{
