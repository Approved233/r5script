...
global function RadioPlay_SetOnCompleteCallback
...
struct {
	string GUID = ""
	void functionref() onCompleteFunc = null
} file
...
void function RadioPlay_SetOnCompleteCallback( void functionref() func )
{
	file.onCompleteFunc = func
}