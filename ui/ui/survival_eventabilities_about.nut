...
array< featureTutorialTab > function EventAbilities_PopulateAboutText()
{
	...
	tab1Rules.append( UI_FeatureTutorialDialog_BuildDetailsData( "#UPRISE_EVENT_ABOUT_OVERVIEW_1_HEADER", "#UPRISE_EVENT_ABOUT_OVERVIEW_1_BODY", $"rui/hud/gametype_icons/ltm/about_shadowroyal_1" ) )
	tab1Rules.append( UI_FeatureTutorialDialog_BuildDetailsData( "#UPRISE_EVENT_ABOUT_OVERVIEW_2_HEADER", "#UPRISE_EVENT_ABOUT_OVERVIEW_2_BODY", $"rui/hud/gametype_icons/ltm/about_shadowroyal_2" ) )
	tab1Rules.append( UI_FeatureTutorialDialog_BuildDetailsData( "#UPRISE_EVENT_ABOUT_OVERVIEW_3_HEADER", "#UPRISE_EVENT_ABOUT_OVERVIEW_3_BODY", $"rui/hud/gametype_icons/ltm/about_shadowroyal_3" ) )
